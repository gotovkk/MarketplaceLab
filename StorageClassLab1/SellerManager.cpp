...
bool SellerManager::login(sqlite3* db, const std::string& username, const std::string_view& password) const {
...
bool SellerManager::getSellerIdByUsername(sqlite3* db, const std::string& username, int& seller_id) const {
